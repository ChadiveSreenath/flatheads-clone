...
const ProductDetail = () => {
  ...
  let SingleProduct = JSON.parse(window.localStorage.getItem("proCard"))
    ...
    <div className="product-detail">
      <div className="product-content">
        ...
        <div className="content-wrapper">
          ...
          <Button onClick={() => Addtocart(SingleProduct)} sx={{ width: "35vw", color: "white", backgroundColor: "#fdd300", padding: "0.5rem 0", ":hover": { backgroundColor: "white", color: "black", }, textDecoration: 'none' }} >ADD TO CART</Button>
